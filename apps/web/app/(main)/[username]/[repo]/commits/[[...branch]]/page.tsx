...
export default function CommitsPage({ params }: { params: Promise<{ username: string; repo: string; branch?: string[] }> }) {
  const { username, repo: repoName, branch: branchSegments } = use(params);
