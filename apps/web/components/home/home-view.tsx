...
import { RiAddLine, RiBookOpenLine, RiGitBranchLine, RiSearchLine } from "@remixicon/react"
        ...
        <div className="mx-auto grid w-full max-w-7xl items-center gap-12 px-6 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          ...
          <div className="relative mx-auto w-full max-w-2xl">
            ...
            <div className="rounded-xl bg-muted/50 p-0.5 shadow-2xl">
              <div className="overflow-hidden rounded-[calc(var(--radius)*1.4-2px)] border bg-card">
